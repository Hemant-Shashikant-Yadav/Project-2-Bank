...
void customer::customer_request(int no, string name, int user, int opt, string loanName)
{
    ...
    */
    ...
    case 1:
        ...
        fileptr << name << " created an account, account no. = " << no << ". Please approve." << endl;
        fileptr.close();

        fileptr.open("pending_request_customer.txt", ios::app);
        fileptr << name << " , account no. = " << no << ". The request of opening an account is sent to cashier. They will approve the request shotly.Please wait." << endl;
        fileptr.close();
        cout << endl;
    ...
    case 2:
        ...
        case 1:
            ...
            fileptr << name << ", account no. = " << no << ". Customer wants a credit card. Please approve." << endl;
            fileptr.close();

            fileptr.open("pending_request_customer.txt", ios::app);
            fileptr << name << " , id no. = " << no << ". The request for credit card is sent to manager. They will approve the request shotly.Please wait." << endl;
            fileptr.close();
        ...
        case 2:
            ...
            fileptr.open("request_manager.txt", ios::app);
            fileptr << name << ", account no. = " << no << ". Customer wants a " << loanName << " loan. Please approve." << endl;
            fileptr.close();

            fileptr.open("pending_request_customer.txt", ios::app);
            fileptr << name << " , id no. = " << no << ". The request for a " << loanName << " loan is sent to manager. They will approve the request shotly.Please wait." << endl;
            fileptr.close();
        ...
        case 3:
            ...
            fileptr.open("request_manager.txt", ios::app);
            fileptr << name << ", account no. = " << no << ". Customer wants to close account. Please approve." << endl;
            fileptr.close();

            fileptr.open("pending_request_customer.txt", ios::app);
            fileptr << name << " , id no. = " << no << ". The request for closing account is sent to manager. They will approve the request shotly.Please wait." << endl;
            fileptr.close();
...
void cashier::cashier_request(int no, string name)
{
    ...
    fileptr.open("request_manager.txt", ios::app);
    fileptr << name << " created an id, id no. = " << no << ". Please approve." << endl;
    fileptr.close();

    fileptr.open("pending_request_cashier.txt", ios::app);
    fileptr << name << " , id no. = " << no << ". The request of opening an id is sent to manager. They will approve the request shotly.Please wait." << endl;
    fileptr.close();
